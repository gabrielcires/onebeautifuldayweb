$(function () {
    ...
    $(window).scroll(function () {
        stickHeader();
        $(function() {
        var menuS4 = $('#section4').offset();
        var scrollPos = $(window).scrollTop();
        var windowSize = $(window).width();

        if (scrollPos == menuS4.top && windowSize > 1200) {
          $('.header').addClass('header-obdf');
          $('.header a').addClass('header-obdf-text');
          $.fn.fullpage.reBuild();
        } else {
          $('.header').removeClass('header-obdf');
          $('.header a').removeClass('header-obdf-text');
        }
      });
    });
